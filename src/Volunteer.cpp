...
void CollectorVolunteer::resetTimeLeft()
{
    timeLeft = coolDown;
}
...
{
    return (!isBusy() && order.getDistance() <= maxDistance && order.getStatus() == OrderStatus::DELIVERING);
}
...
void DriverVolunteer::setDistance(int distance)
{
